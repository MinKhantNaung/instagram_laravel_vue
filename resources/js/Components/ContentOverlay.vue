...
<template>
    <div @mouseenter="isHover = true" @mouseleave="isHover = false" @click="$emit('selectedPost', postByUser)"
        class="flex items-center justify-center cursor-pointer relative">
        <div :class="isHover ? 'bg-black bg-opacity-40' : ''"
        ...
        <img class="aspect-square mx-auto z-0 object-cover cursor-pointer" :src="`/storage/post_images/${postByUser.file}`">
    </div>
</template>
